    ...
    <div className="relative h-full flex flex-col rounded-r-2xl">
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="lg:mx-5 mt-6 lg:mt-10">
          ...
          <div className="bg-[#26262D] rounded-lg border border-[#393B42] p-3 relative" style={{height: '64px'}}>
            <div className="flex items-center gap-3 h-full">
              {/* Style Icon */}
              <div className="w-11 h-11 bg-[#393B42] rounded-lg flex items-center justify-center flex-shrink-0">
                <img src="/images/generate/no-style.png" alt="Style" className="w-6 h-6" />
              </div>
              ...
              {/* Clear Icon */}
              <img src="/images/generate/right-arrow.png" alt="Arrow" className="w-4 h-4 flex-shrink-0" />
            </div>
          </div>
        </div>
