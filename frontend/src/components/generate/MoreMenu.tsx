...
const MoreMenu: React.FC<MoreMenuProps> = ({
  ...
  const handleShareToX = (e: React.MouseEvent) => {
    ...
    setShowShareSubmenu(false);
    onReportClick(); // This will close the main menu
        ...
        >
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4">
            <g clipPath="url(#clip0_1721_4622)">
              <path d="M6.95162 3.08382C7.5273 2.06841 8.46881 2.06841 9.0444 3.08382L13.7505 11.3885C14.3255 12.405 13.8547 13.2342 12.7046 13.2342H3.29147C2.14133 13.2342 1.67005 12.405 2.24557 11.3885L6.95162 3.08382ZM7.99948 10.1405C7.79688 10.1405 7.62887 10.2074 7.49557 10.3407C7.36237 10.474 7.29537 10.6445 7.29537 10.8524C7.29539 11.055 7.36228 11.223 7.49557 11.3563C7.62887 11.4896 7.79688 11.5564 7.99948 11.5565C8.20209 11.5565 8.37007 11.4895 8.50338 11.3563C8.6367 11.223 8.70357 11.055 8.70358 10.8524C8.70358 10.6444 8.63669 10.474 8.50338 10.3407C8.37005 10.2073 8.20214 10.1405 7.99948 10.1405ZM7.33541 5.49983L7.37545 6.69222L7.59127 9.42854H8.40768L8.6235 6.69222L8.66354 5.49983H7.33541Z" fill="#ECECEC" className="group-hover:fill-[#98FF59]"/>
            </g>
            <defs>
          ...
          <span className="text-[#ECECEC] text-xs font-normal group-hover:text-[#98FF59]">Report</span>
        </button>
        ...
        >
          ...
          >
            ...
            <svg width="5" height="6" viewBox="0 0 5 6" fill="none" xmlns="http://www.w3.org/2000/svg" className="ml-auto">
              <path d="M5 3L0.5 5.59808L0.5 0.401924L5 3Z" fill="#D9D9D9" className="group-hover:fill-[#98FF59]"/>
            </svg>
          </button>
              ...
              >
                <div className="flex flex-col gap-[8px]">
                  ...
                  >
                    ...
                    <span className="text-[#ECECEC] text-xs font-normal group-hover:text-[#98FF59] whitespace-nowrap">Share to X</span>
                  </button>
                  ...
                  >
                    ...
                    <span className="text-[#ECECEC] text-xs font-normal group-hover:text-[#98FF59] whitespace-nowrap">Share to Facebook</span>
                  </button>
                </div>
              </div>
            </>
