    ...
    <div className="absolute top-full mt-2 right-0 bg-[#26262D] border border-[#393B42] rounded-lg shadow-lg px-3 py-1 w-[136px] z-50">
      <div className="flex flex-col gap-[8px]">
        ...
        >
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4">
            <g clipPath="url(#clip0_1721_4622)">
              <path 
                ...
                style={{ ':hover': { fill: colors.special.highlight } }}
              />
            </g>
            <defs>
          ...
          <span 
            className="text-[#ECECEC] text-xs font-normal group-hover:text-current"
            style={{ ':hover': { color: colors.special.highlight } }}
          >
            Report
          </span>
        </button>
        ...
        >
          ...
          >
              ...
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4">
                ...
                onMouseEnter={(e) => {
                  ...
                  if (parent && parent.matches(':hover')) {
                    e.currentTarget.style.fill = colors.special.highlight;
                  }
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.fill = '#ECECEC';
                }}/>
              </svg>
              <span className="text-[#ECECEC] text-xs font-normal"
            style={{
              color: '#ECECEC'
            }}
            onMouseEnter={(e) => {
            ...
            <svg width="5" height="6" viewBox="0 0 5 6" fill="none" xmlns="http://www.w3.org/2000/svg" className="ml-auto">
              <path d="M5 3L0.5 5.59808L0.5 0.401924L5 3Z" fill="#D9D9D9" className=""
                style={{
                  fill: '#ECECEC'
                }}
                onMouseEnter={(e) => {
            ...
            <>
              ...
              >
                <div className="flex flex-col gap-[8px]">
                  ...
                  >
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4">
                      <path d="M9.52 6.77L15.48 0H14.06L8.88 5.88L4.76 0H0L6.24 8.96L0 16H1.42L6.88 9.78L11.24 16H16L9.52 6.77ZM7.6 8.97L6.98 8.09L1.92 1.03H4.08L8.16 6.72L8.78 7.6L14.06 15.01H11.9L7.6 8.97Z" fill="#ECECEC" className=""
                style={{
                  fill: '#ECECEC'
                }}
                onMouseEnter={(e) => {
                ...
                onMouseLeave={(e) => {
                  e.currentTarget.style.fill = '#ECECEC';
                    ...
                    <span className="text-[#ECECEC] text-xs font-normal whitespace-nowrap"
                    style={{
                      color: '#ECECEC'
                    }}
                    onMouseEnter={(e) => {
                  ...
                  >
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4">
                      <path d="M16 8C16 3.58 12.42 0 8 0S0 3.58 0 8C0 11.97 2.84 15.23 6.56 15.91V10.31H4.59V8H6.56V6.23C6.56 4.29 7.73 3.2 9.48 3.2C10.32 3.2 11.2 3.36 11.2 3.36V5.25H10.24C9.3 5.25 8.94 5.81 8.94 6.39V8H11.12L10.72 10.31H8.94V15.91C12.66 15.23 16 11.97 16 8Z" fill="#ECECEC" className=""
                style={{
                  fill: '#ECECEC'
                }}
                onMouseEnter={(e) => {
