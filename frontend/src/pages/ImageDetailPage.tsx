...
const ImageDetailPage: React.FC = () => {
  ...
  return (
    ...
    <SEOHead
      ...
      canonicalUrl={(category && image) ? `${window.location.origin}/categories/${getCategoryPathById(category.id)}/${getImageNameById(image.id)}` : `${window.location.origin}/imgs/${imageId}`}
    />
